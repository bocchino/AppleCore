...
perhaps interesting as a matter of language design.  First, AppleCore
natively supports integer arithmetic (both signed and unsigned) on
fixed-size variables of up to 255 bytes.  For example, you can declare
and initialize variables \kwd{A} and \kwd{B}, each of size 16 bytes
unsigned, and then the expression \kwd{A+B} also has size 16, and it
represents the 16-byte unsigned addition of \kwd{A} and \kwd{B} in the
