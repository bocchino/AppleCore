...
an expression, then the compiler (1) evaluates the expression of the
constant declaration to a numeric constant according to the rules in
...
with an assembler label.  This feature exists so that an AppleCore
file that is compiled and linked against an assembly file may refer to
labels defined in the assembly file.
