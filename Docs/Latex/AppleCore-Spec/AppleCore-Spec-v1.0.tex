...
the value of \nonterm{expr} or generate an assembler label for
\nonterm{expr}.  In the second case, the value associated with the
assembler label may not be known until final assembly
...
\bfhead{Constant declarations} If the constant declaration contains
an expression \nonterm{expr}, then the compiler (1) evaluates
\nonterm{expr} to a numeric constant according to the rules in
