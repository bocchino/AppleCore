...
* -------------------------------
* SET SIZE=A
* DIVIDE SP[-2*A,A] BY SP[-A,A]
* QUOTIENT IN SP[-2*A,A]
* REMAINDER IN SP[-A,A]
...
* RHS < 0, NEGATE
	...
	JSR ACC.NOT
* DO THE DIVISION
.2	JSR ACC.DIV.UNSIGNED
* FIX UP SIGNS OF Q AND R
	JSR ACC.SP.DOWN.SIZE
	LDA ACC.GR
	BEQ .3
* NEGATE REMAINDER
...
* NEGATE QUOTIENT
	SEC
	JSR ACC.NOT
.4	JSR ACC.SP.UP.SIZE
	JMP ACC.SP.UP.SIZE
* -------------------------------
* INNER LOOP FOR UNSIGNED DIV
* ON ENTRY SP POINTS TO LHS,
* IP POINTS TO RHS
* -------------------------------
ACC.DIV.INNER
* SHIFT LHS 1 TO LEFT
