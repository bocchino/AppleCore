...
\end{enumerate}
% 
Uses of a function declaration may come before or after the function
declaration in the source file.  For all other declarations, all uses
of the declaration must come after the declaration in the source
file.
