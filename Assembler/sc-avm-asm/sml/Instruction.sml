...
fun pass2 (output,sourceLine,inst,addr,map) = 
    case inst of
	Native inst => Native.pass2 (output,sourceLine,inst,addr,map)
      | Directive inst => Directive.pass2 (output,sourceLine,inst,addr,map)
      | AppleCore inst => AppleCore.pass2 (output,sourceLine,inst,addr,map)
